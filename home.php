...
<head>
	...
	<link rel="icon" type="x-icon" href="images.png">
...
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
    	...
    	<img src="images.png" width="30" height="30" class="d-inline-block align-top" alt=""> College Prediction
  		</a>
  <!-- Links -->
	...
	<div class="background">
		...
		<form method="post" action="home.php">
			<div id="center">
				...
				<input class="ip" type="text" name="bits" placeholder="Cut off"><br><br>
